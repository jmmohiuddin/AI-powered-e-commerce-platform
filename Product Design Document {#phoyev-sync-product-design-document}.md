# Phoyev Sync — Product Design Document
...
| **Implements** | Phoyev Sync — Product Requirements Document v1.0 |
| **Inherits from** | Phoyev Commerce reverse\-engineering audit, §9 (9 Aug 2026) |
...
Every other screen in Phoyev shows the user something they asked to see. Phoyev Sync shows them something they hope never to think about.
...
**"Real\-time" is banned from the product.** It is the word every competitor uses and none of them quantifies. Phoyev shows the measured number instead — that is the positioning, and the copy has to carry it.
